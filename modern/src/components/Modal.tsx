...
export function Modal({open, title, onClose, children}: PropsWithChildren<ModalProps>){
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-xl border w-[min(760px,96vw)] max-h-[90vh] grid" style={{gridTemplateRows:'auto 1fr auto'}}>
